...
func init() {
  ...
  "paths": {
    ...
    "/frb/health": {
      "get": {
        ...
        "description": "Returns a payload containing the health of the service, used by ECS",
        "consumes": [
          "application/json"
        ],
        "produces": [
  ...
  "securityDefinitions": {
    "oauth2": {
      ...
      "scopes": {
        "trf-dev-1/m2m:external": "M2M for external parties adjudicating trips in TRF in DEV-1",
        "trf-dev-2/m2m:external": "M2M for external parties adjudicating trips in TRF in DEV-2",
        "trf-tst-1/m2m:external": "M2M for external parties adjudicating trips in TRF in TST-1",
        "trf-tst-2/m2m:external": "M2M for external parties adjudicating trips in TRF in TST-2"
      }
    }
  }
}`))
