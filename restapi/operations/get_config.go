...
type GetConfigHandlerFunc func(GetConfigParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetConfigHandlerFunc) Handle(params GetConfigParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetConfigHandler interface for that can handle valid get config params
type GetConfigHandler interface {
	Handle(GetConfigParams, interface{}) middleware.Responder
}
...
/*GetConfig swagger:route GET /frb/config getConfig
